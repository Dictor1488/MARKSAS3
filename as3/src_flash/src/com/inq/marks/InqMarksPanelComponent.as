package com.inq.marks
{
    ...
    public class InqMarksPanelComponent extends Sprite
    {
        ...
        private function _redrawMarkBadgeCompact():void
        {
            ...
            g.lineStyle(1.0, 0x85919C, 0.70, true);
            g.beginFill(0x18212A, 0.46);
        ...
        private function _redrawMarkBadgeCompactCurrent():void
        {
            ...
            g.lineStyle(1.0, 0x7C8791, 0.67, true);
            g.beginFill(0x18212A, 0.44);
            g.drawRoundRect(0, 0, badgeW, badgeH, 12, 12);
            g.endFill();

            g.lineStyle(1.0, 0x9099A2, 0.59, true);
            g.beginFill(0x26313B, 0.48);
